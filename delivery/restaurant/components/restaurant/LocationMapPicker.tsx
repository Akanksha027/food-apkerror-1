      ...
      <View style={styles.root}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.currentLocationSub}>
                    {gpsReady
                      ...
                      : 'Use your current GPS position for the restaurant'}
                  </Text>
                </View>
        ...
        >
          ...
          <View style={styles.detectedRow}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.detectedLabel}>RESTAURANT LOCATION</Text>
          ...
          <TouchableOpacity
            ...
            accessibilityLabel="Confirm restaurant location"
          >
            {locating && !detectedAddress ? (
